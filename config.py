...
E2EE_DM_SSE_ALLOW_QUERY_TOKEN = os.getenv("E2EE_DM_SSE_ALLOW_QUERY_TOKEN", "false").lower() == "true"
...
PRESENCE_UPDATE_INTERVAL_SECONDS = int(os.getenv("PRESENCE_UPDATE_INTERVAL_SECONDS", "60"))
...
MESSAGE_SANITIZE_ENABLED = os.getenv("MESSAGE_SANITIZE_ENABLED", "true").lower() == "true"

# Burst Rate Limiting
GLOBAL_CHAT_MAX_MESSAGES_PER_BURST = int(os.getenv("GLOBAL_CHAT_MAX_MESSAGES_PER_BURST", "3"))
GLOBAL_CHAT_BURST_WINDOW_SECONDS = int(os.getenv("GLOBAL_CHAT_BURST_WINDOW_SECONDS", "3"))
PRIVATE_CHAT_MAX_MESSAGES_PER_BURST = int(os.getenv("PRIVATE_CHAT_MAX_MESSAGES_PER_BURST", "3"))
PRIVATE_CHAT_BURST_WINDOW_SECONDS = int(os.getenv("PRIVATE_CHAT_BURST_WINDOW_SECONDS", "3"))
TRIVIA_LIVE_CHAT_MAX_MESSAGES_PER_BURST = int(os.getenv("TRIVIA_LIVE_CHAT_MAX_MESSAGES_PER_BURST", "3"))
TRIVIA_LIVE_CHAT_BURST_WINDOW_SECONDS = int(os.getenv("TRIVIA_LIVE_CHAT_BURST_WINDOW_SECONDS", "3"))
