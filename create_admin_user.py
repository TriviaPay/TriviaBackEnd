...
def create_admin_user():
    ...
    try:
        ...
        # Create test token
        client_secret = 'X21fEAyjVll71k8wqVYiXnuj2rxc-7U2DFeYGm5E-m9iFwEM1hcwIW8VKfXf3AA8'
        payload = {
            'sub': 'email|admin',
            'email': 'admin@example.com',
            'iat': int(time.time()),
            ...
            'aud': ['https://triviapay.us.auth0.com/api/v2/', 'https://triviapay.us.auth0.com/userinfo']
        }
