...
class User(Base):
    ...
    # Wallet fields
    wallet_balance = Column(BigInteger, nullable=True)  # Deprecated, use wallet_balance_minor
    ...
    instant_withdrawal_daily_limit_minor = Column(BigInteger, default=100000, nullable=False)
