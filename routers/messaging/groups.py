...
from models import Group, GroupParticipant, User
...
class CreateGroupRequest(BaseModel):
    ...
    about: Optional[str] = Field(
        None, max_length=500, example="This is a test group for E2EE messaging"
    )
    photo_url: Optional[str] = Field(
        None, example="https://example.com/group-photo.jpg"
    )
...
class UpdateGroupRequest(BaseModel):
    title: Optional[str] = Field(
        None, min_length=1, max_length=100, example="Updated Group Title"
    )
    about: Optional[str] = Field(
        None, max_length=500, example="Updated group description"
    )
    photo_url: Optional[str] = Field(
        None, example="https://example.com/new-group-photo.jpg"
    )
...
def update_group(
    ...
    if participant.role not in ["owner", "admin"]:
        raise HTTPException(
            status_code=403, detail="Insufficient permissions. Owner or admin required."
        )
